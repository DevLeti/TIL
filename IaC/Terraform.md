...
### 왜 서브넷을 2개나?
하나만 만들어도 당연히 EC2 인스턴스를 사용할 수 있습니다. 하지만 AWS에서는 다중 AZ라는 기능을 제공합니다. 두 AZ간 유사한 리소스를 각각 두어서 사용하는데 한쪽이 서비스 장애가 일어났을 때 빠르게 다른 한쪽이 서비스를 이어받아 장애로 인한 서비스 중단을 예방할 수 있는 장점이 있습니다. 그러므로 서브넷을 2개 만든 후 각각 같은 인스턴스를 만들면 서비스가 중단될 확률을 줄일 수 있습니다.
